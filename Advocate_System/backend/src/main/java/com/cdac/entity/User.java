...
public class User {
	...
	@Column(name = "advocate_image")  // annotation for advocateImage
	...
	public static AdvocateRegisterDto toUserDto(User user) {
		AdvocateRegisterDto userDto = new AdvocateRegisterDto();
